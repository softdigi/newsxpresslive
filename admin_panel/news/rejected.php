...
<head>
    ...
    <style>
        ...
        .tab-nav a.active{color:#dc3545;border-bottom-color:#dc3545;font-weight:bold}
    </style>
</head>
<body>
<div class="container">
    <h1>Rejected News (<?php echo $total; ?>)</h1>

    <div class="tab-nav">
        <a href="index.php">All News</a>
        <a href="pending.php">Pending</a>
        <a href="approved.php">Approved</a>
        <a href="rejected.php" class="active">Rejected</a>
    ...
    <form method="get" class="filters">
        ...
        <div style="padding-top:18px"><button type="submit" class="btn btn-primary">Filter</button> <a href="rejected.php" class="btn btn-secondary">Reset</a></div>
    </form>

    <table>
        <thead>
            <tr><th>Title</th><th>Reporter</th><th>Views</th><th>Created</th><th>Actions</th></tr>
        </thead>
        <tbody>
        <?php if (empty($news_list)): ?>
            <tr><td colspan="5" style="text-align:center">No rejected news found.</td></tr>
        <?php else: ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="approve.php?id=<?php echo (int)$n['id']; ?>" class="btn btn-sm btn-success">Re-Approve</a>
                    <a href="delete.php?id=<?php echo (int)$n['id']; ?>" class="btn btn-sm btn-secondary">Delete</a>
                </td>
            </tr>
            <?php endforeach; ?>
        <?php endif; ?>
