...
$rawQuery  = strip_tags($rawQuery);
$rawQuery  = mb_substr($rawQuery, 0, 200);
...
<div class="layout-main">
    ...
    <section class="section" aria-labelledby="search-heading">
        ...
        <!-- Search form (inline repeat for context) -->
        <form class="search-form search-form--inline" action="<?= SITE_URL ?>/news/search.php" method="get" role="search">
            <label for="search-inline" class="sr-only">Search</label>
            <input type="search" id="search-inline" name="q"
        ...
        <?php renderPagination($total, $perPage, $page, SITE_URL . '/news/search.php?q=' . urlencode($rawQuery)); ?>
        <?php endif; ?>
        <?php endif; ?>
