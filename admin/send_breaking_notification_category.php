...
if (
    ...
    jsonResponse(false, [], "admin_uid, news_id, category_id required");
}
...
/* Build category topic */
$topic = "category_" . (int)$input['category_id'];
...
jsonResponse(true, [
    "topic" => $topic
], "category wise breaking notification sent");
